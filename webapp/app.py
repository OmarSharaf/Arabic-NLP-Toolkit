...
async def project_profile() -> dict[str, Any]:
    ...
    return {
        ...
        "features": [
            {"icon": "🌍", "title": "Dialect detection", "title_ar": "كشف اللهجة", "desc": "8 Arabic dialects with confidence scores"},
            {"icon": "💬", "title": "Sentiment", "title_ar": "تحليل المشاعر", "desc": "Negation-aware, dialect-tuned polarity"},
            {"icon": "🏷️", "title": "NER", "title_ar": "الكيانات المسماة", "desc": "Persons, places, organizations, dates"},
            {"icon": "🔑", "title": "Keywords", "title_ar": "كلمات مفتاحية", "desc": "Ranked extraction with stopword filtering"},
            {"icon": "📋", "title": "Text profiling", "title_ar": "ملف النص", "desc": "Register, quality score, recommendations"},
            {"icon": "🔤", "title": "Transliteration", "title_ar": "النقل الحرفي", "desc": "Franco-Arabic, Buckwalter, Arabic"},
            {"icon": "🔬", "title": "Morphology & POS", "title_ar": "صرف ونحو", "desc": "Roots, patterns, stemming, POS tags"},
            {"icon": "📦", "title": "Document export", "title_ar": "تصدير JSON", "desc": "Pydantic v2 pipeline for APIs & ETL"},
        ],
